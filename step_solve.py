...
# Usage
resume_checkpoint = "/content/drive/MyDrive/clip_weights/clip4_ft_epoch_10.pt"
...
def save_checkpoint(model, optimizer, scheduler, epoch, training_losses, validation_losses, is_final=False):
    ...
    if is_final:
        save_path = f"{ft_checkpoints_folder}/clip_rf_ft_epoch_{epoch+1}_final.pt"
    else:
        save_path = f"{ft_checkpoints_folder}/clip_rf_ft_epoch_{epoch+1}.pt"
